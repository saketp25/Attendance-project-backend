...
{
    /// <inheritdoc />
    public partial class Temp_IdentitySchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
           ...
           /* migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassStudents", x => new { x.class_id, x.student_id });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SessionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    session_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    class_id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    session_schedule = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
