...
CREATE TABLE [dbo].[ClassStudents] (
    ...
    [student_id] int NOT NULL,
    CONSTRAINT [PK_ClassStudents] PRIMARY KEY ([class_id], [student_id])
);

CREATE TABLE [dbo].[Sessions] (
    [SessionId] int NOT NULL IDENTITY,
    [session_name] nvarchar(50) NOT NULL,
    [class_id] nvarchar(max) NOT NULL,
    [session_schedule] datetime2 NOT NULL,
...
VALUES (N'20251111024954_Temp_IdentitySchema', N'9.0.9');
